...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.lbl_cnpj = QLabel('Digite o cnpj a ser consultado')
        self.txt_cnpj = QLineEdit()
        self.btn_consultar = QPushButton('Consultar CNPJ')
        self.lbl_resultado = QLabel()

        #Componentes a serem preenchidos com a resposta
        ...
        #Criação e inserção dos widget no layout
        layout = QVBoxLayout()
        ...
        #Widget a ser demontrado na janela
    ...
    def obter_dados_cnpj(self, cnpj):
        ...
        try:
            ...
            self.lbl_resultado.setText(f'Erro ao consutar CNPJ. Erro {e}')
        return None
